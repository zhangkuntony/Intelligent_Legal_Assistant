  ...
  <div class="roles-container">
    ...
    <el-card>
      ...
      <el-table :data="roleList" style="width: 100%" v-loading="loading">
        <el-table-column prop="name" label="角色名称" width="150" header-align="center" align="center" />
        <el-table-column prop="code" label="角色代码" width="150" header-align="center" align="center" />
        <el-table-column prop="description" label="描述" min-width="200" header-align="center" align="left" />
        <el-table-column prop="user_count" label="用户数" width="150" header-align="center" align="center" />
        <el-table-column label="系统角色" width="150" header-align="center" align="center">
    ...
    >
      <div v-loading="loadingPermissions"> 
        ...
        >
          ...
          <el-table-column prop="module" label="所属模块" width="100" header-align="center" align="center">
            <template #default="scope">
...
const loadRolePermissions = async (role: Role) => {
  ...
  // 监听 selectedPermissionIds 的变化，自动更新表格选中状态
  watch(selectedPermissionIds, (newIds) => { 
    nextTick(() => {
      if (permissionTableRef.value && permissionList.value.length > 0) {
        permissionList.value.forEach(p => {
          const isSelected = newIds.includes(p.id)
          permissionTableRef.value.toggleRowSelection(p, isSelected)
        })
      }
    })
  })
